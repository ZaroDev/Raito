...
void main()
{
    ...
    vec4 fragPos = u_View * texture(u_Position, TexCoords);
    vec3 normal = mat3(u_View) * texture(u_Normal, TexCoords).rgb;
    ...
    for(int i = 0; i < u_KernelSize; ++i)
    {
        ...
        // get sample depth
        float sampleDepth = vec3(u_View * texture(u_Position, offset.xy)).z; // get depth value of kernel sample
